...
<html lang="en">
	...
	<body data-spy="scroll" data-target="#my-navbar">
		...
		<div id="main-wrapper" class="container">
			<div class="row">
				<div class="col-md-12">
					<h1>About Bethany Negash</h1>
				</div>
				</div> <!-- end row -->
				<div class="row">
					<img src="img/facility/Image_1.JPG" class="col-lg-3 col-md-5 col-sm-12" alt="Bethany Negash Picture">
					<div class="col-lg-9 col-md-7 col-sm-12" style="background-color:#A3BFE4;padding: 30px;">
						<h2>Our Mission</h2>
