						...
						<a href="#">
							<div class="bkgd-color">
								<div class="panel-content">
									<img src="img/facility/image_1.jpg" alt="Bethany Facility Image">
									<h3 class="project-title">
										Books for Kids
										<br>
										<p class="project-author">Written by: [Name]</p>
									</h3>
				...
				<h1 class="section-title-custom">Statistics</h1>
					<div class="col-md-4 stat-wrapper">
						...
						<div class="row stat-panel">
							<div class="col-sm-12">
								...
								<img class="stat-icon" src="img/icons/connection.svg">
							</div>
							<div class="col-sm-12 stat-text" alt="website visitor icon">
								Current:9999
								<br>
								Total:9999
							</div>
					...
					<div class="col-md-4 stat-wrapper load-fac-visitor-stat-here">
						...
						<div class="row stat-panel">
							<div class="col-sm-12">
								<div class="icon-credit">Icons made by <a href="http://www.freepik.com" title="Freepik">Freepik</a> from <a href="http://www.flaticon.com" title="Flaticon">www.flaticon.com</a> is licensed by <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank">CC 3.0 BY</a></div>
								<img class="stat-icon" src="img/icons/foot.svg" alt="facility visitor icon">
							</div>
							<div class="col-sm-12 stat-text">
								Current:9999
								<br>
